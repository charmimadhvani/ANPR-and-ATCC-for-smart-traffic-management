...
if __name__ == "__main__": 
	...
	findPlate = PlateFinder(minPlateArea=4100, 
								maxPlateArea=15000) 
	model = OCR(modelFile=r"C:\Users\Mugdhi Saxena\Documents\Mugdhi S\Infosys Springboard\internship\project files\ANPR_and_ATCC_for_Smart_Traffic_Management\binary_128_0.50_ver3.pb", 
							labelFile=r"C:\Users\Mugdhi Saxena\Documents\Mugdhi S\Infosys Springboard\internship\project files\ANPR_and_ATCC_for_Smart_Traffic_Management\binary_128_0.50_labels_ver2.txt") 

	cap = cv2.VideoCapture(r'C:\Users\Mugdhi Saxena\Documents\Mugdhi S\Infosys Springboard\internship\project files\videos\anpr\test.MOV') 
